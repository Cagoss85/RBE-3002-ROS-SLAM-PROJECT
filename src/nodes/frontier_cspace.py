...
class Frontier:
    ...
    def returnCentroids(self,msg):
        ...
        frontierGroups = self.splitFrontiers(frontiers)
    ...
    def dilateAndErode(self, frontierGrid):
        ...
        self.c_space = deepcopy(fixedFrontiers)
    ...
    def getCentroids(self, list):
        ...
        for each in list:
            ...
            point.z = len(each)
            if len(each) > 3: #get rid of all frontiers that are only 3 square long
    ...
    def all_neighbors_of_4(self, x, y, mapdata):
        """
        Returns the walkable 4-neighbors cells of (x,y) in the occupancy grid.
        :param mapdata [OccupancyGrid] The map information.
        :param x, y    [int]           The X and Y coordinate in the grid.
    ...
    def all_neighbors_of_8(self, x, y,mapdata):
        """
        Returns the walkable 8-neighbors cells of (x,y) in the occupancy grid.
        :param mapdata [OccupancyGrid] The map information.
        :param x       [int]           The X coordinate in the grid.
